                            ...
                            <div class="col-lg-4">
                                <div class="btn-group float-md-right d-block">
                                    ...
                                    <button class="btn btn-info dropdown-toggle" type="button" data-toggle="dropdown"
                                            aria-haspopup="true" aria-expanded="false">Change Order Status
                                    </button>
                            ...
                            <table class="table product-table color-table primary-table">
                                ...
                                @foreach($order_products as $order_product)
                                    ...
                                    <tr>
                                        ...
                                        <td><img src="{{asset($product->image)}}" style="height:100px; width:100px;"
                                                 alt="" title=""></td>
                                        <td style="background: {{!is_null($order_product->colors) ? $order_product->colors : 'transparent'}};"></td>
                        ...
                        <div class="product-table text-dark no-border">
                            <table class="table m-b-5 m-t-20 ">
                                ...
                                <tr>
                                    ...
                                    <td class="text-color">{{$order->delivery_address_1}}
                                        ,{{$order->delivery_country}} {{$order->delivery_city}}
                                        , {{$order->delivery_state}}</td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
