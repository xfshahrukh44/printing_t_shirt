                    ...
                    <div class="main-art">
                         ...
                         <div class="shirt-art" data-aos="flip-left" data-aos-duration="2000">
                              <a href="javascript:;">
                                   <div class="shirt-art-img">
                                        <figure>
                                             <img src="{{ asset('images/9.png') }}" class="img-fluid" alt="">
                                        </figure>
                                   </div>
                                   <div Art T Shirtv class="discription-shirt">
                                        <h6>Digital Art Hoodie</h6>
                                   </div>
                              </a>
                         </div>
                    </div>
...
{{--                    </div>--}}
               ...
               <div class="col-lg-3">
                    <div class="product-slider" data-aos="fade-up" data-aos-duration="2000">
                         <div class="shirt-slides">
                              <a href="javascript:;">
                                   <div class="product-carousel owl-carousel owl-theme">
                                        <div class="item">
          ...
          <div class="row">
               <div class="col-lg-12">
                    ...
                    <div class="emial-letter">
                         ...
                         <input type="button" class="btn light-blue-btn" value=" Subscribe">
                    </div>
               </div>
          </div>
     </div>
